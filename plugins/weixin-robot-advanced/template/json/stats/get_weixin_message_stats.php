...
$results	= $wpdb->get_results($wpdb->prepare("SELECT * FROM $wpdb->weixin_mp_messages WHERE blog_id = %d AND ref_date >= %s AND ref_date <= %s ORDER BY ref_date DESC, msg_type ASC", $blog_id, $begin_date, $end_date));
