...
if(!WPJAM_Verify::verify()){
	wp_redirect(admin_url('admin.php?page=wpjam-extends'));
	exit;		
}
	...
	$sections	= [ 
		...
		'layout'	=>[
			...
			'fields'	=>[
				...
				'show_post_author'	=> ['title'=>'作者',		'type'=>'checkbox',	'description'=>'显示文章作者及头像']
			]
		],
		'foot_setting'	=>[
			'title'		=>'页脚设置', 
		...
		'weapp'	=>[
			...
			'fields'	=>[
				'share_image'	=> ['title'=>'首页分享图',		'type'=>'img',	'item_type'=>'url',	'size'=>'500x400',	'description'=>'尺寸：500x400'],
			],
