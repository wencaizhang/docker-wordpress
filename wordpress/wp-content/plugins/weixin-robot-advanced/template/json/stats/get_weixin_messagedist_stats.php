...
$results	= $wpdb->get_results($wpdb->prepare("SELECT * FROM $wpdb->weixin_mp_messagedists WHERE blog_id = %d AND ref_date >= %s AND ref_date <= %s ORDER BY ref_date DESC, count_interval ASC", $blog_id, $begin_date, $end_date));
